 ...
 *
 */
if ( ! class_exists( 'CHIPPYMTC_Field_textarea' ) ) {
  class CHIPPYMTC_Field_textarea extends CHIPPYMTC_Fields {
    ...
    public function shortcoder() {
      ...
      if ( ! empty( $this->field['shortcoder'] ) ) {
        ...
        $instances  = ( ! empty( CHIPPYMTC::$shortcode_instances ) ) ? CHIPPYMTC::$shortcode_instances : array();
          ...
          foreach ( $shortcodes as $shortcode ) {
            ...
            foreach ( $instances as $instance ) {
              ...
              if ( $instance['modal_id'] === $shortcode ) {
                ...
                echo '<a href="#" class="button button-primary chippymtc-shortcode-button" data-modal-id="'. esc_attr( $id ) .'">'. esc_html( $title ) .'</a>';
