 ...
 *
 */
if ( ! class_exists( 'CHIPPYMTC_Field_sortable' ) ) {
  class CHIPPYMTC_Field_sortable extends CHIPPYMTC_Fields {
    ...
    public function render() {
      ...
      echo '<div class="chippymtc-sortable" data-depend-id="'. esc_attr( $this->field['id'] ) .'">';
      ...
      foreach ( $pre_sortby as $key => $field ) {
        ...
        echo '<div class="chippymtc-sortable-item">';

          echo '<div class="chippymtc-sortable-content">';
          ...
          CHIPPYMTC::field( $field, $field_value, $unique_id, 'field/sortable' );

          echo '</div>';

          echo '<div class="chippymtc-sortable-helper"><i class="fas fa-arrows-alt"></i></div>';
