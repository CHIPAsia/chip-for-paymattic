 ...
 *
 */
if ( ! class_exists( 'CHIPPYMTC_Field_color' ) ) {
  class CHIPPYMTC_Field_color extends CHIPPYMTC_Fields {
    ...
    public function render() {
      ...
      echo '<input type="text" name="'. esc_attr( $this->field_name() ) .'" value="'. esc_attr( $this->value ) .'" class="chippymtc-color"'. $default_attr . $this->field_attributes() .'/>';
