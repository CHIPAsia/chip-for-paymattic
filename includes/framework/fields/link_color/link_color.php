 ...
 *
 */
if ( ! class_exists( 'CHIPPYMTC_Field_link_color' ) ) {
  class CHIPPYMTC_Field_link_color extends CHIPPYMTC_Fields {
    ...
    public function render() {
      ...
      $color_props = array(
        'color'    => esc_html__( 'Normal', 'chippymtc' ),
        'hover'    => esc_html__( 'Hover', 'chippymtc' ),
        'active'   => esc_html__( 'Active', 'chippymtc' ),
        'visited'  => esc_html__( 'Visited', 'chippymtc' ),
        'focus'    => esc_html__( 'Focus', 'chippymtc' )
      );
      ...
      foreach ( $color_props as $color_prop_key => $color_prop_value ) {
        ...
        if ( ! empty( $args[$color_prop_key] ) ) {
          ...
          echo '<div class="chippymtc--left chippymtc-field-color">';
          echo '<div class="chippymtc--title">'. esc_attr( $color_prop_value ) .'</div>';
          echo '<input type="text" name="'. esc_attr( $this->field_name( '['. $color_prop_key .']' ) ) .'" value="'. esc_attr( $value[$color_prop_key] ) .'" class="chippymtc-color"'. $default_attr . $this->field_attributes() .'/>';
          echo '</div>';
