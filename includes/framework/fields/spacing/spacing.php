 ...
 *
 */
if ( ! class_exists( 'CHIPPYMTC_Field_spacing' ) ) {
  class CHIPPYMTC_Field_spacing extends CHIPPYMTC_Fields {
    ...
    public function render() {
      ...
      if ( ! empty( $args['all'] ) ) {
        ...
        echo '<input type="number" name="'. esc_attr( $this->field_name( '[all]' ) ) .'" value="'. esc_attr( $value['all'] ) .'"'. $placeholder .' class="chippymtc-input-number'. esc_attr( $is_unit ) .'" step="any" />';
        echo ( $unit ) ? '<span class="chippymtc--label chippymtc--unit">'. esc_attr( $args['units'][0] ) .'</span>' : '';
        echo '</div>';
        ...
        foreach ( $properties as $property ) {
          ...
          echo '<input type="number" name="'. esc_attr( $this->field_name( '['. $property .']' ) ) .'" value="'. esc_attr( $value[$property] ) .'"'. $placeholder .' class="chippymtc-input-number'. esc_attr( $is_unit ) .'" step="any" />';
          echo ( $unit ) ? '<span class="chippymtc--label chippymtc--unit">'. esc_attr( $args['units'][0] ) .'</span>' : '';
          echo '</div>';
