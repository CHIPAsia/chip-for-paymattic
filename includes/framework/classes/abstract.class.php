 ...
 *
 */
if ( ! class_exists( 'CHIPPYMTC_Abstract' ) ) {
  abstract class CHIPPYMTC_Abstract {
    ...
    public function __construct() {
      ...
      if ( ! empty( $this->args['output_css'] ) || ! empty( $this->args['enqueue_webfont'] ) ) {
        ...
        CHIPPYMTC::$css = apply_filters( "chippymtc_{$this->unique}_output_css", CHIPPYMTC::$css, $this );
      }
    ...
    public function recursive_output_css( $fields = array(), $combine_field = array() ) {
      ...
      if ( ! empty( $fields ) ) {
        ...
        foreach ( $fields as $field ) {
          ...
          $field_class  = 'CHIPPYMTC_Field_' . $field_type;
